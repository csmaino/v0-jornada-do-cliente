    ...
    <section id="contato" className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Entre em contato</h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Pronto para começar seu projeto? Entre em contato conosco e vamos conversar sobre suas ideias.
          </p>
        </div>
